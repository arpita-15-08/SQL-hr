...
DELETE FROM employees WHERE employee_id IN (202,203,204,205,206);
DESCRIBE employees;
INSERT INTO employees
VALUES (
	202,
...
USE hr;
SELECT * FROM employees;
-- Display the firstname,ladstname,email of all employees
...
-- Retrieve the employees qho were hired after January 1,2015
SELECT * FROM employees WHERE hire_date>'2015-01-01';
-- List all employees who have salary greater then 5000.
...
-- Retrieve all employees whose first name ends with 'A' and ends with 'n'
SELECT * FROM employees WHERE first_name="A%n";
-- Display the employees who donot have commision.
...
-- Display the employee's first name and length of their first name
SELECT first_name,LENGTH(first_name) AS LEN_NAME FROM employees;

-- Convert the hire_date of employees to display only the year
SELECT employee_id,YEAR(hire_date) AS YEAR_OF_HIRING FROM employees; 

-- Retrieve the minimum and maximum salary for each job title.
use hr;
show tables;
SELECT * FROM jobs;
SELECT  MIN(salary) AS MIN_SALARY, MAX(salary) AS MAX_SALARY FROM employees E JOIN jobs J ON E.job_id=j.job_id GROUP BY job_title;
...
show tables;
SELECT CONCAT(first_name,'',last_name) AS FULL_NAME,E.job_id FROM employees E JOIN jobs J on E.job_id= J.job_id;

-- Retrieve the department names along with the count of employees in each department. 
SELECT * FROM departments;
SELECT * FROM employees;
SELECT E.employee_id,D.department_name FROM departments D JOIN employees E ON D.department_id=E.department_id;
...
SELECT E.first_name FROM employees E JOIN job_history JH ON E.job_id=JH.job_id;
